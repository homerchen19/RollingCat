var menuState = {
    create: function() {
        ...
        var noodle = game.add.sprite(innerWidth * 4 / 5 - Width * scaleWidth / 2, innerHeight / 2 - Height * scaleHeight / 2, 'noodle');
        ...
        var text1 = game.add.text(innerWidth * 6 / 8, innerHeight * 3 / 5, '阿瑞意麵', {
            fontSize: 0.02 * innerWidth + 'px',
            fill: '#ff8888'
        });
        var text2 = game.add.text(innerWidth * 11 / 16, innerHeight * 18 / 20, '點擊關卡開始遊戲', {
            fontSize: 0.03 * innerWidth + 'px',
            fill: '#888888'
        });
